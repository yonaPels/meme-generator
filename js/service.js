...
let gMeme = {
    selectedImgId: 5, selectedLineIdx: 0, lines: [
        { posX: 0, posY: 60, txt: 'I sometimes eat Falafel', size: 20, align: 'left', color: 'red', strokeColor: 'brown', font: 'impact' },
    ]
}
...
function addLine() {
    const line = { posX: 0, posY: 300, txt: 'Somthing else', size: 20, align: 'left', color: 'red', strokeColor: 'brown', font: 'impact' }
